#!/bin/bash
#
# Command: wget -q "--no-check-certificate" https://raw.githubusercontent.com/islam-2412/mytrans/main/fury/installer.sh -O - | /bin/sh
#
echo "------------------------------------------------------------------------"
...
opkg remove enigma2-plugin-extensions-mytranslator > /dev/null 2>&1
...
FILE_NAME="mytrans_${PY_VER}.ipk"
DOWNLOAD_URL="https://raw.githubusercontent.com/islam-2412/mytrans/main/fury/${FILE_NAME}"
...
#
echo "------------------------------------------------------------------------"
echo "        This work is exclusive to Ismail Alkholy (( MyTranslator ))      "
echo "------------------------------------------------------------------------"
echo "                              Abou Yassin                               "
